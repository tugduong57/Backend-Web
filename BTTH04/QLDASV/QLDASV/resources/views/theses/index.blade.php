		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ route('theses.create') }}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm đồ án mới</span></a>
				...
				<tbody>
                    @foreach ($theses as $thesis)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('theses.edit', $thesis->id) }}" class="btn btn-primary">Sửa</a>
        
                                <!-- Nút xóa kèm modal xác nhận -->
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $thesis->id }}">
                                    Xóa
                                </button>
